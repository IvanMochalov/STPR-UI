import{j as e,r as c}from"./iframe-DsoVLqtF.js";import{I as U,E as m}from"./Icon-CcD0Smza.js";import{c as v}from"./clsx-B-dksMZM.js";import{I as $}from"./Tooltip-B9F4jJYp.js";import{T as o}from"./Text-Da_aKhKS.js";import"./preload-helper-DCNYn41m.js";import"./BaseTooltip-CyUiU66m.js";import"./Potral-7FViUbta.js";import"./index-Cz879DlY.js";import"./index-CMC9NNB4.js";const J="_spTabs_30yrx_1",K="_spTabs_separated_30yrx_18",Q="_spTabs__tabElement_30yrx_43",X="_spTabs__tabElement_active_30yrx_48",Y="_spTabs__tabContent_30yrx_48",Z="_spTabs__tooltip_30yrx_55",ee="_spTabs__iconContainer_30yrx_133",ae="_spTabs__tabText_30yrx_142",l={spTabs:J,spTabs_separated:K,"spTabs--size-md":"_spTabs--size-md_30yrx_23","spTabs--size-xl":"_spTabs--size-xl_30yrx_31","spTabs--variant-contained":"_spTabs--variant-contained_30yrx_39",spTabs__tabElement:Q,spTabs__tabElement_active:X,spTabs__tabContent:Y,spTabs__tooltip:Z,"spTabs--variant-outlined":"_spTabs--variant-outlined_30yrx_67","spTabs--variant-filled":"_spTabs--variant-filled_30yrx_86",spTabs__iconContainer:ee,spTabs__tabText:ae},r=t=>{const{panes:n,isSeparated:s=!1,classNameRoot:a,classNameTabElementRoot:E,classNameBaseTooltipRoot:G,variant:g="contained",size:j="xl"}=t,O=v({[l.spTabs]:!0,[l.spTabs_separated]:s,[l[`spTabs--variant-${g}`]]:g,[l[`spTabs--size-${j}`]]:j,...a&&{[a]:!0}}),D=v({[l.spTabs__iconContainer]:!0}),M=v({[l.spTabs__tooltip]:!0}),z=v({[l.spTabs__tabContent]:!0}),S=(d,b)=>d?e.jsx("div",{className:D,children:e.jsx(U,{name:d,rotate:b})}):null,q=(d,b)=>{const{name:R,active:P,onClick:F,infoTooltipText:W,isOnlyIcon:T=!1,startIconName:h,endIconName:A,startIconRotate:w=0,endIconRotate:V=0}=d,B=!T&&!!h,L=!T&&!!A,H=!T;return e.jsx("div",{"aria-label":T?R:void 0,className:v({[l.spTabs__tabElement]:!0,[l.spTabs__tabElement_active]:P,...E&&{[E]:!0}}),onClick:F,children:e.jsxs("div",{className:z,children:[T?S(h,w):e.jsxs(e.Fragment,{children:[S(B?h:void 0,w),H&&e.jsx("span",{className:l.spTabs__tabText,children:R}),S(L?A:void 0,V)]}),!!W&&e.jsx($,{hover:!0,classNameTooltip:M,text:W,classNameBaseTooltipRoot:G})]})},d.key||b)};return e.jsx("div",{className:O,children:n.map((d,b)=>q(d,b))})};r.__docgenInfo={description:"",methods:[],displayName:"Tabs",props:{size:{required:!1,tsType:{name:"union",raw:'"md" | "xl"',elements:[{name:"literal",value:'"md"'},{name:"literal",value:'"xl"'}]},description:""},panes:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{\r
  name: string;\r
  key?: string;\r
  active?: boolean;\r
