import{r as _,j as e}from"./iframe-CA4deTFl.js";import{B as l}from"./Button-enFxszJ_.js";import{u as m}from"./index-CXmG2N0V.js";import{c as i}from"./clsx-B-dksMZM.js";import{I as H,E as f}from"./Icon-DndJayG8.js";import{S as z}from"./Spinner-8qRTIFQm.js";import{T as q}from"./Text-DSk7EiGw.js";import{L as W}from"./Layer-COehigPG.js";import"./preload-helper-JD0jGv3q.js";import"./Potral-CkHkY5OB.js";import"./index-SbPXkCt7.js";import"./index-DESwEi8l.js";const F="_viewImageModal_2zawy_1",U="_viewImageModal__img_2zawy_24",D="_viewImageModal__img_loading_2zawy_37",$="_viewImageModal__img_error_2zawy_40",A="_viewImageModal__spinner_2zawy_43",Q="_viewImageModal__layer_2zawy_70",Z="_viewImageModal__closeButton_2zawy_75",t={viewImageModal:F,viewImageModal__img:U,viewImageModal__img_loading:D,viewImageModal__img_error:$,viewImageModal__spinner:A,viewImageModal__layer:Q,viewImageModal__closeButton:Z},G="/components-assets/ViewImageModal/fallBackSrc.jpeg",r=o=>{const{classNameRoot:a,classNameImageRoot:n,src:s,onLoad:h,onError:b,fallbackSrc:M=G,showLoader:S=!0,onClose:k}=o,[v,I]=_.useState(!0),[y,C]=_.useState(!1),[x,O]=_.useState(s),j=i({[t.viewImageModal]:!0,...a&&{[a]:!0}}),L=i({[t.viewImageModal__layer]:!0}),V=i({[t.viewImageModal__closeButton]:!0}),R=i({[t.viewImageModal__spinner]:!0}),B=i(t.viewImageModal__img,{[t.viewImageModal__img_loading]:v,[t.viewImageModal__img_error]:y,...n&&{[n]:!0}}),N=w=>{I(!1),h?.(w)},T=w=>{I(!1),C(!0),M&&x!==M&&(O(M),C(!1),I(!0)),b?.(w)};return e.jsxs(W,{classNameRoot:L,children:[S&&v&&e.jsx(z,{classNameRoot:R,size:"xl"}),e.jsxs("div",{className:j,children:[e.jsx("img",{className:B,src:x,alt:"someImage",onLoad:N,onError:T}),y&&e.jsxs("div",{className:t.viewImage__errorWrapper,children:[e.jsx(H,{name:f.InfoError,className:t.viewImage__errorIcon}),e.jsx(q,{children:"Не удалось загрузить изображение"})]})]}),e.jsx(l,{classNameRoot:V,onClick:k,variant:"link",isOnlyIcon:!0,startIconName:f.Close})]})};r.__docgenInfo={description:"",methods:[],displayName:"ViewImageModal",props:{src:{required:!0,tsType:{name:"string"},description:""},fallbackSrc:{required:!1,tsType:{name:"string"},description:"Резерв при ошибке загрузки `src`. По умолчанию — статика пакета: `dist/components-assets/ViewImageModal/fallBackSrc.jpeg` (корень сайта); пустая строка отключает подмену."},zIndex:{required:!1,tsType:{name:"number"},description:""},classNameRoot:{required:!1,tsType:{name:"string"},description:""},classNameImageRoot:{required:!1,tsType:{name:"string"},description:""},showLoader:{required:!1,tsType:{name:"boolean"},description:""},onError:{required:!1,tsType:{name:"signature",type:"function",raw:"(event: React.SyntheticEvent<HTMLImageElement, Event>) => void",signature:{arguments:[{type:{name:"ReactSyntheticEvent",raw:"React.SyntheticEvent<HTMLImageElement, Event>",elements:[{name:"HTMLImageElement"},{name:"Event"}]},name:"event"}],return:{name:"void"}}},description:""},onLoad:{required:!1,tsType:{name:"signature",type:"function",raw:"(event: React.SyntheticEvent<HTMLImageElement, Event>) => void",signature:{arguments:[{type:{name:"ReactSyntheticEvent",raw:"React.SyntheticEvent<HTMLImageElement, Event>",elements:[{name:"HTMLImageElement"},{name:"Event"}]},name:"event"}],return:{name:"void"}}},description:""},onClose:{required:!0,tsType:{name:"signature",type:"function",raw:"(event: React.MouseEvent<HTMLButtonElement>) => void",signature:{arguments:[{type:{name:"ReactMouseEvent",raw:"React.MouseEvent<HTMLButtonElement>",elements:[{name:"HTMLButtonElement"}]},name:"event"}],return:{name:"void"}}},description:""}}};const J="/themes/main/assets/storybook/assets/viewImageExample-BEm_hxQS.jpg",K="_customViewImageModal_1rpzk_1",P="_customImageStyle_1rpzk_7",E={customViewImageModal:K,customImageStyle:P},ce={title:"Components/ViewImageModal",component:r,tags:["autodocs"],parameters:{docs:{description:{component:`
