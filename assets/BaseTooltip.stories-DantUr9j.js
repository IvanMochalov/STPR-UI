import{j as t}from"./iframe-DFzgFXfL.js";import{B as i}from"./BaseTooltip-70cfOlMv.js";import{B as c}from"./Button---xTaN4m.js";import"./preload-helper-DCNYn41m.js";import"./clsx-B-dksMZM.js";import"./Icon-FLtHPxG2.js";import"./Spinner-BxCCScEk.js";const d="_decoratorWrapper_120tq_1",p="_hintMuted_120tq_7",s={decoratorWrapper:d,hintMuted:p},y={title:"Components/BaseTooltip",component:i,tags:["autodocs"],argTypes:{text:{description:"Содержимое тултипа. Может быть строкой или React-компонентом\nПоддерживает переносы строк через `white-space: pre-line`\n",control:{type:"text"},table:{type:{summary:"string | ReactNode"}}},noPadding:{description:`Убрать внутренние отступы (padding) тултипа
