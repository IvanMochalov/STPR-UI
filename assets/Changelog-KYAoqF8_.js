import{j as e}from"./iframe-DsoVLqtF.js";import{u as s,M as l,T as c,S as r}from"./blocks-ClLtoJXP.js";import"./preload-helper-DCNYn41m.js";import"./index-Cz879DlY.js";import"./index-CMC9NNB4.js";function i(d){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",hr:"hr",li:"li",p:"p",strong:"strong",ul:"ul",...s(),...d.components};return e.jsxs(e.Fragment,{children:[e.jsx(l,{title:"Documentation/Changelog"}),`
`,e.jsx(c,{children:"История версий"}),`
`,e.jsxs(r,{children:["Текущая версия пакета в репозитории: ",e.jsx(n.strong,{children:"1.0.1"}),"."]}),`
...
`,e.jsx(n.h2,{id:"101--2026-06-08",children:"[1.0.1] — 2026-06-08"}),`
`,e.jsx(n.h3,{id:"fixed",children:"Fixed"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["Пакет: удалён ",e.jsx(n.code,{children:"postinstall"}),", из-за которого ",e.jsx(n.code,{children:"npm install test-stpr-ui-kit"}),` падал у потребителей (скрипт\r
`,e.jsx(n.code,{children:"copy-web-ifc-wasm.mjs"})," не входил в опубликованный tarball). Копирование ",e.jsx(n.code,{children:"web-ifc.wasm"}),` выполняется только при\r
`,e.jsx(n.code,{children:"npm run build:lib"})," / сборке Storybook в репозитории библиотеки; wasm по-прежнему поставляется в ",e.jsx(n.code,{children:"dist/"}),"."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"Tabs"}),": исправлено использование токенов компонента, что приводило к потере высоты компонента в предыдущей версии;"]}),`
`]}),`
...
`,e.jsx(n.h3,{id:"fixed-8",children:"Fixed"}),`
`,e.jsxs(n.ul,{children:[`
