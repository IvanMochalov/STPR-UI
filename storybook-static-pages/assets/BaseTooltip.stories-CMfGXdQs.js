import{j as t}from"./iframe-CA4deTFl.js";import{B as i}from"./BaseTooltip-CuZNMgt3.js";import{B as c}from"./Button-enFxszJ_.js";import"./preload-helper-JD0jGv3q.js";import"./clsx-B-dksMZM.js";import"./Icon-DndJayG8.js";import"./Spinner-8qRTIFQm.js";const d="_decoratorWrapper_120tq_1",p="_hintMuted_120tq_7",s={decoratorWrapper:d,hintMuted:p},y={title:"Components/BaseTooltip",component:i,tags:["autodocs"],argTypes:{text:{description:"Содержимое тултипа. Может быть строкой или React-компонентом\nПоддерживает переносы строк через `white-space: pre-line`\n",control:{type:"text"},table:{type:{summary:"string | ReactNode"}}},noPadding:{description:`Убрать внутренние отступы (padding) тултипа
