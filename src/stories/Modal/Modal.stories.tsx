...
### Large (lg) - 920px max-width
- Стандартный размер для большинства модальных окон
- Большие отступы: 64px на desktop, 20px на мобильных
- Подходит для сложных форм и большого контента

### Medium (md) - 600px max-width  
- Компактный размер для уведомлений и простых действий
- Умеренные отступы: 32px на desktop, 20px на мобильных
- Идеален для подтверждений и кратких сообщений

## Структура модального окна

### Header
- Основной заголовок (обязательный)
- Отображается как заголовок третьего уровня или кастомный React-компонент
- Автоматически освобождает место для кнопки закрытия

### SubHeader
- Дополнительный подзаголовок (опциональный React-компонент)
- Меньший шрифт, отступ сверху
- Может использоваться без основного заголовка
...
### Footer
- Область для кнопок действий (опционально)
- Обычно содержит ApplyButtons или подобные компоненты

## Особенности поведения

### Блокировка скролла
- При открытии модального окна страница фиксируется
- Сохраняется позиция скролла для правильного восстановления
- Предотвращает прокрутку фонового контента

### Кнопка закрытия
- Располагается в правом верхнем углу
- Автоматически адаптирует размер под размер модального окна
- Может быть скрыта через пропс isVisibleCloseButton

## Адаптивность

- **Мобильные**: минимальная ширина 335px, отступы 20px
- **Планшеты и выше**: максимальная ширина по размеру (параметр size), увеличенные отступы

## Рекомендации по использованию

### Базовое модальное окно:
- Хук useModal экспортируется также из "test-stpr-ui-kit";
