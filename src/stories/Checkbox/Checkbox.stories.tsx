...
### Large (lg) - 30px
- Стандартный размер для большинства случаев
- Иконка галочки 17x17px
- Рекомендуется для основных форм

### Medium (md) - 20px  
- Компактный размер для плотных интерфейсов
- Иконка галочки 12x12px
- Подходит для таблиц и списков

## Состояния чекбокса

### Checked
- Отображает галочку внутри квадрата
- Изменяет цвет бордера и фона

### Disabled
- Визуально затемненный вид
- Блокирует взаимодействие
- Сохраняет текущее состояние

### Error
- Красный бордер для индикации ошибки
- Отображает текст ошибки под чекбоксом

## Дополнительные функции

### Required
- Отображает звездочку (*) рядом с лейблом
- Визуальный индикатор обязательности поля

### Tooltip
- Показывает всплывающую подсказку
- Настраиваемое позиционирование
- Полезно для пояснения сложных опций

## Адаптивность

- **Мобильные**: текст 16px
- **Планшеты и выше**: текст 20px
        `,
      },
    },
  },
